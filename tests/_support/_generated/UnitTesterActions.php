<?php  //[STAMP] 96e413f0d32a71f32fe07bbc72c178d8
...
trait UnitTesterActions
{
     ...
     */
    public function expectEvent(string $class, string $eventName, $callback, string $eventInstance = "", array $eventValues = []) {
     ...
     */
    public function assertEqualDates(\Codeception\TestInterface $test, string $dateOne, string $dateTwo, float $secondsDelta = 5.0) {
     ...
     */
    public function mockMethods(\yii\base\Module $module, string $component, array $params = [], array $constructorParams = []) {
