<?php  //[STAMP] 28754bf79cfb08cc8fe2f82559212ff6
...
trait FunctionalTesterActions
{
    ...
    public function setupDb(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('setupDb', func_get_args()));
    }
    ...
    public function installPlugin(array $plugin): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('installPlugin', func_get_args()));
    }
     ...
     */
    public function normalizePathSeparators(mixed $path): string|false {
    ...
    public function expectEvent(string $class, string $eventName, callable $callback, string $eventInstance = "", array $eventValues = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('expectEvent', func_get_args()));
    }
     ...
     */
    public function saveElement(\craft\base\ElementInterface $element, bool $failHard = true): bool {
     ...
     */
    public function deleteElement(\craft\base\ElementInterface $element, bool $hardDelete = true, bool $failHard = true): bool {
    ...
    public function assertTestFails(callable $callable, string $message = ""): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertTestFails', func_get_args()));
    }
     ...
     */
    public function assertEqualDates(\Codeception\TestInterface $test, string $dateOne, string $dateTwo, float $secondsDelta = 5.0): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertEqualDates', func_get_args()));
    }
     ...
     */
    public function mockMethods(\yii\base\Module $module, string $component, array $params = [], array $constructorParams = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('mockMethods', func_get_args()));
    }
    ...
    public function mockCraftMethods(string $component, array $params = [], array $constructorParams = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('mockCraftMethods', func_get_args()));
    }
    ...
    public function runQueue(string $queueItem, array $params = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('runQueue', func_get_args()));
    }
    ...
    public function assertPushedToQueue(string $description): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertPushedToQueue', func_get_args()));
    }
     ...
     *
     * @param string $description
     * @see \craft\test\Craft::assertNotPushedToQueue()
     */
    public function assertNotPushedToQueue(string $description) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('assertNotPushedToQueue', func_get_args()));
    }
     ...
     */
    public function getFieldLayoutByFieldHandle(string $fieldHandle): ?\craft\models\FieldLayout {
